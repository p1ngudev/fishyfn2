...
module.exports = class Client extends EventEmitter {
    ...
    handleauth(message) {
        ...
        this.botJid = `Galaxy@prod.ol.epicgames.com/V2:Fortnite:WIN::${parsed[0]}`
        ...
        if (message.root.attributes.type == "chat") {
            ...
            if (msg.startsWith("!skin ")) {
                ...
                axios.get(`https://fortnite-api.com/v2/cosmetics/br/search?name=${name}&matchMethod=contains&type=outfit`).then(response => {
                    ...
                    fs.writeFile('./config/Galaxy/config.json', JSON.stringify({
                ...
                'body': {
                    "#text": JSON.stringify({
                        ...
                        "member_state_updated": {
                            "urn:epic:member:dn_s": "Galaxy",
                            "urn:epic:member:joinrequestusers_j": "{\"users\":[{\"id\":\"Galaxy\",\"dn\":\"Galaxy\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}"
                        },
                        "joined_at": new Date(),
                        "updated_at": new Date()
                    })
    ...
    JoinBot(PartyId) {
        ...
        setTimeout(() => {
            ...
            try {
                global.BotConfig = JSON.parse(fs.readFileSync('./config/Galaxy/config.json', 'utf8', function (err, data) {
                    ...
                    "#text": JSON.stringify(
                        {
                            ...
                            "type": "com.epicgames.social.party.notification.v0.MEMBER_JOINED",
                            "connection": {
                                "id": `Galaxy${this.NumberOfBot}@prod.ol.epicgames.com/V2:Fortnite:WIN::BOT${this.NumberOfBot}`,
                                "meta": {
                                    "urn:epic:conn:platform_s": "WIN",
                                    "urn:epic:conn:type_s": "game"
                                },
                            ...
                            "ns": "Fortnite",
                            "party_id": PartyId,
                            "account_id": `Galaxy${this.NumberOfBot}`,
                            "account_dn": `Galaxy`,
                            "member_state_updated": {
                                "urn:epic:member:joinrequestusers_j": `{\"users\":[{\"id\":\"Galaxy${this.NumberOfBot}\",\"dn\":\"Galaxy\",\"plat\":\"WIN\",\"data\":\"{\\\"CrossplayPreference_i\\\":\\\"1\\\",\\\"SubGame_u\\\":\\\"1\\\"}\"}]}`,
                                "urn:epic:member:dn_s": `Galaxy`
                            },
                            "joined_at": new Date(),
                            "updated_at": new Date()
